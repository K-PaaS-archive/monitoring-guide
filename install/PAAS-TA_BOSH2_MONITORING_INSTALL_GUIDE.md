...
![PaaSTa_BOSH_Use_Guide_Image2](./images/bosh-monitoring/bosh2.png)

## <div id='2.1'/>● BOSH 컴포넌트 구성

BOSH의 컴포넌트 구성은 다음과 같다.

![PaaSTa_BOSH_Use_Guide_Image3](./images/bosh-monitoring/bosh3.png)
...
```
ubuntu@inception:~/workspace/paasta-5.5.4/deployment/paasta-deployment/bosh$ ssh jumpbox@10.0.1.6 -i jumpbox.key
